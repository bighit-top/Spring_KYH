package springdb1.jdbc.translator;
...
import springdb1.jdbc.repository.ex.MyDuplicateKeyException;
...
public class ExTranslatorV1Test {
    ...
    void duplicateKeySave() {
        service.create("myId");
        service.create("myId"); //오류, 같은 ID 저장 시도
    }
    ...
    static class Repository {
        ...
        public Member save(Member member) {
            ...
            try {
                ...
                //h2 db
                if (e.getErrorCode() == 23505) { //primary key 중복 예외인 경우
