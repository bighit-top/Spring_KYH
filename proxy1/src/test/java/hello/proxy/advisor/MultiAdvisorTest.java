...
public class MultiAdvisorTest {
    ...
    void multiAdvisorTest1() {
        ...
        ProxyFactory proxyFactory1 = new ProxyFactory(target); //target
        ...
        //프록시2 생성
        ProxyFactory proxyFactory2 = new ProxyFactory(proxy1); //proxy1
    ...
    void multiAdvisorTest2() {
        ...
        //프록시 생성
        ServiceInterface target = new ServiceImpl();
        ProxyFactory proxyFactory = new ProxyFactory(target); //target
